  ...
  <div id="right_ok">
     <div class="modal-content">
          ...
          <div class="modal-body">
              <form class="form-user-popup validation-user" method="post" action="{{ route('user.register') }}">
                  @csrf
                  <label>Họ tên</label>
                  <div class="input-group input-user">
                      <div class="input-group-text"><i class="fa fa-user"></i></div>
                      <input type="text" class="form-control text-sm" name="name" placeholder="Nhập họ và tên" required="">
                  </div>
                  ...
                  <div class="input-group input-user">
                      <div class="input-group-text"><i class="fa fa-lock"></i></div>
                      <input type="password" class="form-control text-sm" name="password_confirmation" placeholder="Nhập lại mật khẩu" required="">
                  </div>
                  <label>Giới tính</label>
                  <div class="input-group input-user">
                      <div class="radio-user custom-control custom-radio">
                          <input type="radio" id="nam-dk" name="gender" class="custom-control-input" value="1" required="">
                          <label class="custom-control-label" for="nam-dk">Nam</label>
                      </div>
                      <div class="radio-user custom-control custom-radio">
                          <input type="radio" id="nu-dk" name="gender" class="custom-control-input" value="0" required="">
                  ...
                  <div class="input-group input-user">
                      ...
                      <input type="number" class="form-control text-sm" name="phone" placeholder="Nhập số điện thoại" required="">
                  </div>
                  <label>Địa chỉ</label>
                  <div class="input-group input-user">
                      <div class="input-group-text"><i class="fa fa-map"></i></div>
                      <input type="text" class="form-control text-sm" name="address" placeholder="Nhập địa chỉ" required="">
                  </div>

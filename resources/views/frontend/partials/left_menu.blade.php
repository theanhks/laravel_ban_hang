        ...
        <div class="left dmsp">
            <ul>
                ...
                <li><a href="san-pham/bo-mach-may-laser">
                        <img src="upload/product/laser-6027_30x40.jpg" alt="BO MẠCH MÁY LASER"> BO MẠCH MÁY
                        LASER</a>
                    <ul>
                    </ul>
                </li>
                <li><a href="san-pham/kinh-han-mat-na-han-non-han">
                        <img src="upload/product/f8957a80360ecb50921f-8910_39.967819790829x40.jpg"
                             alt="KÍNH HÀN- MẶT NẠ HÀN- NÓN HÀN"> KÍNH HÀN- MẶT NẠ HÀN- NÓN HÀN</a>
                    <ul>
                    </ul>
                </li>
                <li><a href="san-pham/bo-tao-xung-may-han">
                        <img src="upload/product/3525-13-chan-2929_40x30.jpg" alt="BO TẠO XUNG MÁY HÀN"> BO TẠO XUNG
                        MÁY HÀN</a>
                    <ul>
                    </ul>
                </li>
                ...
                <li><a href="san-pham/bo-nguon-may-han">
                        <img src="upload/product/bo-ic3843-dung-6949_32.03426124197x40.png" alt="BO NGUỒN MÁY HÀN">
                        BO NGUỒN MÁY HÀN</a>
                    <ul>
                    </ul>
                </li>
                ...
                <li><a href="san-pham/bo-tron-chua-gan-lk">
                        <img src="upload/product/bo-tron-2405_40x40.png" alt="Bo Trơn Chưa Gắn LK"> Bo Trơn Chưa Gắn
                        LK</a>
                    <ul>
                    </ul>
                </li>
                <li><a href="san-pham/bo-cao-ap-may-han">
                        <img src="upload/product/bo-cut-60-5889_40x33.120567375887.png" alt="BO CAO ÁP MÁY HÀN"> BO
                        CAO ÁP MÁY HÀN</a>
                    <ul>
                    </ul>
                </li>
                ...
                <li><a href="san-pham/dong-ho-hien-thi-so">
                        <img src="upload/product/dong-ho-lon-660_40x32.671755725191.png"
                             alt="ĐỒNG HỒ - HIỂN THỊ SỐ"> ĐỒNG HỒ - HIỂN THỊ SỐ</a>
                    <ul>
                    </ul>
                </li>
                <li><a href="san-pham/ic-on-ap">
                        <img src="upload/product/ic-3843-9936_40x38.208955223881.png" alt="IC - ỔN ÁP"> IC - ỔN
                        ÁP</a>
                    <ul>
                    </ul>
                </li>
                ...
                <li><a href="san-pham/bien-ap-nguon">
                        <img src="upload/product/bien-ap-nguon-4455_40x40.jpg" alt="Biến Áp Nguồn"> Biến Áp
                        Nguồn</a>
                    <ul>
                    </ul>
                </li>
                ...
                <li><a href="san-pham/giac-ket-noi">
                        <img src="upload/product/jac-1025-2231_40x32.592592592593.jpg" alt="Giắc Kết Nối"> Giắc Kết
                        Nối</a>
                    <ul>
                    </ul>
                </li>
                <li><a href="san-pham/phu-kien-han-mig">
                        <img src="upload/product/hm-co-cong-15ak-2108_40x40.jpg" alt="PHỤ KIỆN HÀN MIG"> PHỤ KIỆN
                        HÀN MIG</a>
                    <ul>
                    </ul>
                </li>
                <li><a href="san-pham/cap-han-kim-han-kep-mass">
                        <img src="upload/product/kim-han-800a-4662_40x25.333333333333.jpg"
                             alt="CÁP HÀN - KÌM HÀN - KẸP MASS"> CÁP HÀN - KÌM HÀN - KẸP MASS</a>
                    <ul>
                    </ul>
                </li>
                <li><a href="san-pham/phu-tung-sua-chua-may-han">
                        <img src="upload/product/mat-nhua-dep-3415_40x30.795262267343.png"
                             alt="PHỤ TÙNG SỬA CHỮA MÁY HÀN"> PHỤ TÙNG SỬA CHỮA MÁY HÀN</a>
                    <ul>
                    </ul>
                </li>
            </ul>
        ...
        <div class="left dmsp">
            <ul>
                ...
                <li><a href="phu-kien-han-cat/phu-kien-sung-han-mig">
                        <img src="upload/product/phu-kien-han-mig-4102_40x40.jpg" alt="Phụ Kiện Súng Hàn Mig"> Phụ
                        Kiện Súng Hàn Mig</a>
                    <ul>
                    </ul>
                </li>
                <li><a href="phu-kien-han-cat/sung-cat-plasma">
                        <img src="upload/product/sung-cat-1-5114_40x40.jpg" alt="Súng Cắt Plasma"> Súng Cắt
                        Plasma</a>
                    <ul>
                    </ul>
                </li>
                ...
                <li><a href="phu-kien-han-cat/phu-kien-cat-plasma">
                        <img src="upload/product/sung-tig-3-5898_40x40.jpg" alt="Phụ Kiện Cắt Plasma"> Phụ Kiện Cắt
                        Plasma</a>
                    <ul>
                    </ul>
                </li>
                <li><a href="phu-kien-han-cat/rua-han-moto-ranh-ra-day">
                        <img src="upload/product/sung-tig-1-4966_40x40.jpg" alt="Rùa Hàn - Moto - Rãnh Ra Dây"> Rùa
                        Hàn - Moto - Rãnh Ra Dây</a>
                    <ul>
                    </ul>
                </li>

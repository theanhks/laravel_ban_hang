            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle shadow-none"
                        ...
                        @case('ru')
                            <img src="{{ asset('/admin/assets/images/flags/russia.svg') }}" class="rounded " alt="Header Language"
                                height="18">
                        @break
                        @case('it')
                            <img src="{{ asset('/admin/assets/images/flags/italy.svg') }}" class="rounded " alt="Header Language"
                                height="18">
                        @break
                        @case('sp')
                            <img src="{{ asset('/admin/assets/images/flags/spain.svg') }}" class="rounded " alt="Header Language"
                                height="18">
                        @break
                        @case('ch')
                            <img src="{{ asset('/admin/assets/images/flags/china.svg') }}" class="rounded " alt="Header Language"
                                height="18">
                        @break
                        @case('fr')
                            <img src="{{ asset('/admin/assets/images/flags/french.svg') }}" class="rounded " alt="Header Language"
                                height="18">
                        @break
                        @case('gr')
                            <img src="{{ asset('/admin/assets/images/flags/germany.svg') }}" class="rounded " alt="Header Language"
                                height="18">
                        @break
                        @default
                            <img src="{{ asset('/admin/assets/images/flags/us.svg') }}" class="rounded " alt="Header Language" height="18">
                    @endswitch
                    </button>
